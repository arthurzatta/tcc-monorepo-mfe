...
const Dashboard = () => {
  ...
  return (
    <div>
      <div id="mfe-dashboard" className="flex gap-2 p-4 bg-[#f8f9fd]">
        <div id="mfe-line-chart" ref={lineChartRef} />
        <div id="mfe-bar-chart" ref={barChartRef} />
        <div id="mfe-bar-chart-2" ref={barChartRef2} />
        <div id="mfe-services-table" ref={servicesTableRef} />
      </div>
    </div>
  );
};
